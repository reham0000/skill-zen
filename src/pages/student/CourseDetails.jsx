    ...
    <>
      <div className="flex md:flex-row  flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-cyan-100/70">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm ">
            Course by <span className="text-blue-600 underline">Skill Zen</span>
          </p>
          ...
          <div className="py-20 text-sm md:text-base">
            ...
            <div
              className="space-y-4 text-gray-700 [&>p]:text-lg [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-2 [&>ul>li]:text-lg"
              dangerouslySetInnerHTML={{
        ...
        {/* Right column */}
        <div className="max-w-course-card z-10 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] p-2">
          {

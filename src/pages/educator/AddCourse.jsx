...
//               type="number"
//               placeholder="0"
//               className="outline-none md:py-2.5 pl-2 py-2 w-28 rounded border border-gray-500"
//               required
//             />
//           </div>
...
//                     </div>
//                   ))}
//                   <div className="inline-flex bg-gray-100 p-2 rounded cursor-pointer my-2">
//                     + Add Lecture
//                   </div>
//                 </div>
//               )}
            ...
            >
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  ...
                  <div
                    className="inline-flex bg-gray-100 p-2 rounded cursor-pointer my-2"
